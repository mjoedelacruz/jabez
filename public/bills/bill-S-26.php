<?php
        ...
        $items = array(new item("EBI TEMPURA","1","230.00","230.00"),new item("PEANUTS","2","75.00","150.00"),new item("PUMPKIN SOUP","1","90.00","90.00"),new item("CALAMARI","1","210.00","210.00"),new item("TOKWA'T BABOY","1","180.00","180.00"),new item("NACHOS WITH SALSA","1","160.00","160.00"),new item("FISH & CHIPS","2","230.00","460.00"),);
        ...
        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("892.86",29," ",STR_PAD_LEFT);

        $printer->text("ZERO RATED SALES\n");
