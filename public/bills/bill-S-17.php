<?php
        ...
        $items = array(new item("EBI TEMPURA","1","230.00","230.00"),new item("PEANUTS","1","75.00","75.00"),new item("CALAMARI","2","210.00","420.00"),);
        ...
        $invNo = str_pad("S-17",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("725.00",32," ",STR_PAD_LEFT);
        ...
        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("725.00",29," ",STR_PAD_LEFT);
