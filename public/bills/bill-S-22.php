<?php
        ...
        $items = array(new item("CALAMARI","1","210.00","210.00"),new item("EBI TEMPURA","1","230.00","230.00"),new item("PEANUTS","1","75.00","75.00"),new item("FISH & CHIPS","1","230.00","230.00"),);
        ...
        $invNo = str_pad("S-22",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("745.00",32," ",STR_PAD_LEFT);
        ...
        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("745.00",29," ",STR_PAD_LEFT);
