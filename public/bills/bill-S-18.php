<?php
        ...
        $items = array(new item("CALAMARI","1","210.00","210.00"),new item("FISH & CHIPS","2","230.00","460.00"),new item("TOKWA'T BABOY","3","180.00","540.00"),new item("EBI TEMPURA","1","230.00","230.00"),new item("PUMPKIN SOUP","1","90.00","90.00"),new item("NACHOS WITH SALSA","1","160.00","160.00"),new item("SEAFOOD CHOWDER","2","170.00","340.00"),);
        ...
        $invNo = str_pad("S-18",3," ",STR_PAD_LEFT);
        ...
        $tableName = str_pad("Table 10",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("1,710.00",32," ",STR_PAD_LEFT);
        ...
        $discountAmount = str_pad("122.14",$discountCols," ",STR_PAD_LEFT);
        $printer->text($discount.$discountAmount."\n");

        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("1,587.86",29," ",STR_PAD_LEFT);
        ...
        $sigName = str_pad("OS-5, OS-23, ",3," ",STR_PAD_LEFT);
