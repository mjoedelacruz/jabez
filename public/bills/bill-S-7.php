<?php
        ...
        $items = array(new item("CALAMARI","2","210.00","420.00"),);
        ...
        $invNo = str_pad("S-7",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("420.00",32," ",STR_PAD_LEFT);
        ...
        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("420.00",29," ",STR_PAD_LEFT);
