<?php
        ...
        $items = array(new item("GARLIC CHICKEN","2","285.00","570.00"),);
        ...
        $invNo = str_pad("S-5",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("570.00",32," ",STR_PAD_LEFT);
        ...
        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("570.00",29," ",STR_PAD_LEFT);
