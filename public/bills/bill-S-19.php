<?php
        ...
        $items = array(new item("CHICKEN SOTANGHON GUISADO","1","285.00","285.00"),new item("CHICKEN CHOW MIEN","1","210.00","210.00"),);
        ...
        $invNo = str_pad("S-19",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("495.00",32," ",STR_PAD_LEFT);
        ...
        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("495.00",29," ",STR_PAD_LEFT);
