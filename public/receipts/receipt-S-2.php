<?php
    ...
    $items = array(new item("CALAMARI","1","210.00","210.00"),new item("PEANUTS","1","75.00","75.00"),new item("BEEF BOLOGNESE (RED)","1","175.00","175.00"),new item("CAESAR SALAD","2","175.00","350.00"),new item("GARDEN SALAD WITH BLACKENED TUNA","1","250.00","250.00"),);
    ...
    $totalAmount = str_pad("775.00",32," ",STR_PAD_LEFT);
    ...
    $discountAmount = str_pad("138.39",$discountCols," ",STR_PAD_LEFT);
    $printer->text($discount.$discountAmount."\n");

    $printer -> setJustification(Printer::JUSTIFY_LEFT);
    $printer -> setEmphasis(true);
    $totalAmount = str_pad("636.61",29," ",STR_PAD_LEFT);
    ...
    $sigName = str_pad("OS-27, OS-29, ",3," ",STR_PAD_LEFT);
