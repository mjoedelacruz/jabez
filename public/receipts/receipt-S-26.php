<?php
    ...
    $items = array(new item("CALAMARI","1","210.00","210.00"),new item("EBI TEMPURA","1","230.00","230.00"),new item("PEANUTS","2","75.00","150.00"),new item("FISH & CHIPS","2","230.00","460.00"),new item("TOKWA'T BABOY","1","180.00","180.00"),new item("NACHOS WITH SALSA","1","160.00","160.00"),new item("PUMPKIN SOUP","1","90.00","90.00"),);
    ...
    $invNo = str_pad("S-26",3," ",STR_PAD_LEFT);
    ...
    $tableName = str_pad("Table 9",3," ",STR_PAD_LEFT);
    $printer -> text("Table".$tableColon.$tableName."\n");

    $numGuestColon = str_pad(":",4," ",STR_PAD_LEFT);
    $numGuestsNum = str_pad("1",3," ",STR_PAD_LEFT);
    ...
    $totalAmount = str_pad("1,000.00",32," ",STR_PAD_LEFT);
    ...
    $printer -> setJustification(Printer::JUSTIFY_LEFT);
    $printer -> setEmphasis(true);
    $totalAmount = str_pad("1,000.00",29," ",STR_PAD_LEFT);
    ...
    $sigName = str_pad("OS-18, OS-19, OS-20, ",3," ",STR_PAD_LEFT);
