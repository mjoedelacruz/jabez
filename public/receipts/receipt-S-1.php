<?php
    ...
    $items = array(new item("KATSUDON WITH RICE","2","205.00","410.00"),);
    ...
    $invNo = str_pad("S-1",3," ",STR_PAD_LEFT);
    ...
    $totalAmount = str_pad("410.00",32," ",STR_PAD_LEFT);
    ...
    $printer -> setJustification(Printer::JUSTIFY_LEFT);
    $printer -> setEmphasis(true);
    $totalAmount = str_pad("410.00",29," ",STR_PAD_LEFT);
    ...
    $sigName = str_pad("OS-26, ",3," ",STR_PAD_LEFT);
    ...
    $paymentList = array(new item("1 - CASH"," - 500.00","",""),);
