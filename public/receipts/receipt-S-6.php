<?php
        ...
        $items = array(new item("GARLIC CHICKEN","5","285.00","1,425.00"),);
        ...
        $invNo = str_pad("S-6",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("1,425.00",32," ",STR_PAD_LEFT);
        ...
        $discountAmount = str_pad("101.79",$discountCols," ",STR_PAD_LEFT);
        $printer->text($discount.$discountAmount."\n");

        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("1,323.21",29," ",STR_PAD_LEFT);
        ...
        $paymentList = array(new item("1" - "CASH","" - "1,500.00","",""),);
