<?php
    ...
    $items = array(new item("CALAMARI","1","210.00","210.00"),new item("EBI TEMPURA","1","230.00","230.00"),new item("CLUB SANDWICH","1","198.00","198.00"),new item("BACON, LETTUCE & TOMATO","2","136.00","272.00"),new item("OREO MILK SHAKE","1","115.00","115.00"),new item("JAVA CHIP","1","150.00","150.00"),);
