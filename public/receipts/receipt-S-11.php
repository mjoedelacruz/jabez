<?php
        ...
        $invNo = str_pad("S-11",3," ",STR_PAD_LEFT);
        ...
        $totalAmount = str_pad("210.00",32," ",STR_PAD_LEFT);
        ...
        $printer -> setJustification(Printer::JUSTIFY_LEFT);
        $printer -> setEmphasis(true);
        $totalAmount = str_pad("210.00",29," ",STR_PAD_LEFT);
