<?php
    ...
    $items = array(new item("CALAMARI","2","210.00","420.00"),new item("EBI TEMPURA","1","230.00","230.00"),new item("PEANUTS","1","75.00","75.00"),);
    ...
    $invNo = str_pad("S-27",3," ",STR_PAD_LEFT);
    $printer -> text("Bill No".$invColon.$invNo."\n");

    $serverColon = str_pad(":",5," ",STR_PAD_LEFT);
    $serverName = str_pad("Renje B. Tag-at",3," ",STR_PAD_LEFT);
    ...
    $numGuestsNum = str_pad("3",3," ",STR_PAD_LEFT);
    ...
    $totalAmount = str_pad("650.00",32," ",STR_PAD_LEFT);
    ...
    $printer -> setJustification(Printer::JUSTIFY_LEFT);
    $printer -> setEmphasis(true);
    $totalAmount = str_pad("650.00",29," ",STR_PAD_LEFT);
    ...
    $sigName = str_pad("OS-21, OS-22, ",3," ",STR_PAD_LEFT);
